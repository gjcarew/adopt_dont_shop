...
ActiveRecord::Schema.define(version: 2022_09_01_214814) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "adopter_pets", force: :cascade do |t|
    t.bigint "pet_id"
    t.bigint "adopter_id"
    t.boolean "status"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["adopter_id"], name: "index_adopter_pets_on_adopter_id"
    t.index ["pet_id"], name: "index_adopter_pets_on_pet_id"
  end
  ...
  add_foreign_key "adopter_pets", "adopters"
  add_foreign_key "adopter_pets", "pets"
